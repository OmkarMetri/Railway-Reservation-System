<?php 
require_once('get_origin.php');
require_once('get_destination.php');
...
<html lang="">
	<head>
		...
		<title>Online Railway Rerservation</title>
					...
					<form class="form-horizontal" role="form" id="form-itinerary">
					  <div class="form-group">
					    ...
					    <?php foreach($origins as $o): ?>
					    	<option value="<?= $o['Source_id']; ?>"><?= $o['Source_station']; ?></option>
				    	<?php endforeach; ?>
					    </select>
					  </div>
					  <div class="form-group">
				    	...
				    	<?php foreach($destinations as $d): ?>
					    	<option value="<?= $d['Destination_id']; ?>"><?= $d['Destination_station']; ?></option>
				    	<?php endforeach; ?>
					    </select>
					  </div>
					  <div class="form-group">
