...
<body>
	...
	<fieldset style="height: 365px;width: 30%;margin-top: 75px">
		<p style="font-size: 30px">Train Search </p>
		<form method="POST" action="">
			<label><input type="text" name="from" placeholder="from" class="hello" required></label><br><br>
			<input type="text" name="to" placeholder="to" class="hello" required><br><br>
			<input type="search" name="Search" class = "button" value="search" style="padding: 12px 20px;display: inline-block;border-radius: 4px ;box-sizing: border-box;"><br>
